export const projects = [
  {
    ...
    technologies:
      'React, Ruby on Rails, ActiveRecord, PostgreSQL, Heroku, Semantic UI, BetterDoc API, Google Geocode API',
    github: {
      main: '',
  ...
  },
  {
    ...
    technologies:
      'Vanilla JS, Ruby on Rails for Leaderboard, ActiveRecord, PostgreSQL, Heroku, Netlify',
    github: {
      main: '',
    ...
    image: {
      imageURL:
        'https://github.com/tsrines/portfolio/blob/master/public/images/NameError.png?raw=true',
      position: 'center',
    },
  },
  {
